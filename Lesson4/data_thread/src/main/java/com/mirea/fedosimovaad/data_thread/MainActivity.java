package com.mirea.fedosimovaad.data_thread;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(
                "1. runOnUiThread выполняется сразу\n" +
                        "2. post ставится в очередь сообщений потока\n" +
                        "3. postDelayed откладывается на заданное время\n\n" +

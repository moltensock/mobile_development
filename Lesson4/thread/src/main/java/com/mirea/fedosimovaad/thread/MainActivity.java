package com.mirea.fedosimovaad.thread;
...
import com.mirea.fedosimovaad.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName("МОЙ НОМЕР ГРУППЫ: 03, НОМЕР ПО СПИСКУ: 19, МОЙ ЛЮБИМЫЙ ФИЛЬМ: Назад в будущее");
